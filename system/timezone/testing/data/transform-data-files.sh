...
TELEPHONYLOOKUP_FILE=android/telephonylookup.xml

INPUT_TZDATA_FILE=${REFERENCE_FILES_DIR}/${TZDATA_FILE}
INPUT_ICU_DIR=${REFERENCE_FILES_DIR}/${ICU_DIR}
INPUT_TZLOOKUP_FILE=${REFERENCE_FILES_DIR}/${TZLOOKUP_FILE}
INPUT_TELEPHONYLOOKUP_FILE=${REFERENCE_FILES_DIR}/${TELEPHONYLOOKUP_FILE}
...
OUTPUT_ICU_DIR=${TEST_DATA_OUTPUT_DIR}/${ICU_DIR}
OUTPUT_TZLOOKUP_FILE=${TEST_DATA_OUTPUT_DIR}/${TZLOOKUP_FILE}
OUTPUT_TELEPHONYLOOKUP_FILE=${TEST_DATA_OUTPUT_DIR}/${TELEPHONYLOOKUP_FILE}
...
sed "s/$SEARCH/$REPLACE/" ${INPUT_ICU_DIR}/zoneinfo64.res > ${OUTPUT_ICU_DIR}/zoneinfo64.res
sed "s/$SEARCH/$REPLACE/" ${INPUT_ICU_DIR}/windowsZones.res > ${OUTPUT_ICU_DIR}/windowsZones.res
sed "s/$SEARCH/$REPLACE/" ${INPUT_ICU_DIR}/timezoneTypes.res > ${OUTPUT_ICU_DIR}/timezoneTypes.res
sed "s/$SEARCH/$REPLACE/" ${INPUT_ICU_DIR}/metaZones.res > ${OUTPUT_ICU_DIR}/metaZones.res
...
# Copy the telephonylookup.xml file. No updates are required.
cp ${INPUT_TELEPHONYLOOKUP_FILE} ${OUTPUT_TELEPHONYLOOKUP_FILE}
