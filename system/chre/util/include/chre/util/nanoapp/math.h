...
#ifndef CHRE_UTIL_NANOAPP_MATH_H_
#define CHRE_UTIL_NANOAPP_MATH_H_

/**
 * @file Helper math functions and constants for nanoapps to use and share.
 *
 * This file is C99 compatible to ensure compatibility with the most nanoapps.
 */
