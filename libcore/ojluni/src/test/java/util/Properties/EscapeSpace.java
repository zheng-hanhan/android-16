...
public class EscapeSpace {
    ...
    // Android-changed: pass File directly.
    // static void load(Properties p, String file) throws Exception
    static void load(Properties p, File file) throws Exception
    {
    ...
    static void store(Properties p, File file) throws Exception
    {
    ...
    public static void main( String args[] ) throws Exception
    {
        ...
        File out = File.createTempFile("out1", "props");
